...
namespace HCL.HackatonHotels.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = HackatonHotelsConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HackatonHotelsDbContext context)
        {
            _context = context;
        }
