...
using HCL.HackatonHotels.Web.Models.Account;
using HCL.HackatonHotels.Web.Views.Shared.Components.TenantChange;

namespace HCL.HackatonHotels.Web.Controllers
{
    public class AccountController : HackatonHotelsControllerBase
    {
